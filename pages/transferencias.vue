      ...
      <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <div class="p-4 border-b border-gray-200">
          <div class="flex flex-wrap gap-4">
            ...
            <select v-model="filters.timeRange" class="rounded-lg border-gray-300 text-sm">
          ...
          <table class="w-full">
            <thead class="bg-gray-50">
              <tr>
                ...
                <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tiempo estimado</th>
        ...
        <!-- Empty State -->
        <div v-if="filteredTransfers.length === 0" class="p-8 text-center">
