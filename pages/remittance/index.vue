						...
						<tbody class="divide-y divide-gray-200 bg-white">
							...
							>
								...
								<td class="px-4 py-5 text-sm text-gray-900 text-nowrap">
									{{ operation.source_user_account?.currency.code }}
									{{ parseFloat(operation.source_amount).toFixed(2) }}
								</td>
								<td class="px-4 py-5 text-sm text-gray-900 text-nowrap">
									{{ operation.destination_user_account?.currency.code }}
									{{ parseFloat(operation.destination_amount).toFixed(2) }}
								</td>
								<td class="px-4 py-5 text-sm text-gray-900 text-nowrap">
									{{ operation.destination_user_account.alias }}
								</td>
