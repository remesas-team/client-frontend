  ...
  <main class="container mx-auto py-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center gap-8 px-4 md:min-h-[calc(100vh-100px)] mt-8">
      <div class="w-full md:w-1/2 justify-center text-center items-center md:items-left md:text-left">
        <span class="bg-green-grass text-white rounded-2xl px-4 py-2 text-sm mb-3 text-nowrap lg:text-lg">🎁 <strong>Regalo:</strong> Cupón 1er envío gratis <a href="#" class="text-[#93f8f4] font-bold ml-2" @click="applyCoupon">WELCOME50</a></span>
