<template>
  <div class="flex flex-col md:flex-row justify-between items-start gap-8 mb-12 bg-white rounded-lg shadow-sm p-6">
    <div class="flex items-start gap-3 flex-1">
      ...
      <span class="text-sm font-medium">Remesas.com es una entidad regulada</span>
    </div>
    ...
    <div class="flex items-start gap-3 flex-1">
      ...
      <span class="text-sm font-medium">Atendemos más de 2k usuarios todos los meses</span>
    </div>
    ...
    <div class="flex items-start gap-3 flex-1">
      ...
      <span class="text-sm font-medium">Soporte y atención al cliente 24/7</span>
    </div>
  </div>
</template>