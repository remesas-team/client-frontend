<template>
  <div class="flex justify-between items-start gap-4 md:gap-8 mb-12 bg-white rounded-lg shadow-sm p-4 md:p-6">
    <div class="flex flex-col md:flex-row items-center gap-2 md:gap-3 flex-1 text-center md:text-left">
      <div class="w-8 h-8 md:w-10 md:h-10 bg-gray-100 rounded-full flex items-center justify-center flex-shrink-0">
        <svg class="w-4 h-4 md:w-5 md:h-5 text-gray-700" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="flex flex-col md:flex-row items-center gap-2 md:gap-3 flex-1 text-center md:text-left">
      ...
      <span class="text-xs md:text-sm font-medium">Atendemos más de 2k usuarios todos los meses</span>
    </div>
