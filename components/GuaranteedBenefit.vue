<template>
  <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
    <div class="bg-gray-100 py-2 px-4 flex items-center justify-center gap-2">
      ...
      <span class="text-sm font-medium text-gray-600">Beneficio garantizado</span>
    </div>

    <div class="p-8 text-center">
      <h3 class="text-xl font-medium mb-2">Remesas inmediatas</h3>
      <p class="text-4xl font-bold mb-2">2 a 3 Horas</p>
      <p class="text-gray-600 mb-8">a todo Brasil</p>
