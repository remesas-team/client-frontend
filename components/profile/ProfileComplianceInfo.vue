<template>
	<div class="bg-white rounded-xl shadow-lg p-6">
		...
		<div class="[&>*]:mb-6">
			...
			<div
				v-if="form.isPep || form.hasPepRelatives"
				class="[&>*]:mb-4"
			>
				<div v-if="form.isPep">
					<label class="block text-sm font-medium text-gray-700 mb-2"> Cargo o Función Pública </label>
					<input
			...
			<!-- Source of Funds -->
			<div>
				<label class="block text-sm font-medium text-gray-700 mb-2"> Origen de los Fondos </label>
				<select
			...
			<div v-if="form.fundsSource === 'other'">
				<label class="block text-sm font-medium text-gray-700 mb-2"> Especifique el origen de los fondos </label>
				<input
